...
"""
    pythonwithgittest.models.message_sent_response

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
import pythonwithgittest.models.message
...
class MessageSentResponse(object):
    ...
    Attributes:
        ...
        number_national_destinations (int): TODO: type description here.
        number_international_destinations (int): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 number_national_destinations=None,
                 number_international_destinations=None):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('messages') != None:
            ...
            for structure in dictionary.get('messages'):
                messages.append(pythonwithgittest.models.message.Message.from_dictionary(structure))
        message_type = dictionary.get('messageType')
        number_segments = dictionary.get('numberSegments')
        number_national_destinations = dictionary.get('NumberNationalDestinations')
        number_international_destinations = dictionary.get('NumberInternationalDestinations')

        # Return an object of this model
        return cls(messages,
                   message_type,
                   number_segments,
                   number_national_destinations,
                   number_international_destinations)
